...
/**
 * Implementation of {@link DomainModule} related to Event Sourcing.
 *
 * @author Alexey Krylov
 * @since 17.02.13
 */
public class EventSourcedDomainModule extends DomainModule<EventSourcedAggregateRoot> {

    /*===========================================[ CONSTRUCTORS ]=================*/

    @SafeVarargs
    public EventSourcedDomainModule(Class<? extends EventSourcedAggregateRoot>... aggregateRootsClasses) {
        super(aggregateRootsClasses);
    }

    public EventSourcedDomainModule(String... aggregatesScanPackages) {
        super(aggregatesScanPackages);
    }

    public EventSourcedDomainModule(Collection<ClassesSearchGroup> aggregatesClassesSearchGroups) {
